...
public class TweetsListFragment$$ViewBinder<T extends TweetsListFragment> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends TweetsListFragment> implements Unbinder {
    ...
    protected InnerUnbinder(T target, Finder finder, Object source) {
      ...
      target.rvTweets = finder.findRequiredViewAsType(source, 2131427460, "field 'rvTweets'", RecyclerView.class);
      target.swipeContainer = finder.findRequiredViewAsType(source, 2131427459, "field 'swipeContainer'", SwipeRefreshLayout.class);
    }
